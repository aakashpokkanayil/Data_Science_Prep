...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        # use groupby to create relevant data for plotting
        average_sales = recession_data.groupby(by='Vehicle_Type')['Automobile_Sales'].mean().reset_index()                           
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        # use groupby to create relevant data for plotting
        exp_rec= recession_data.groupby(by='Vehicle_Type')['Advertising_Expenditure'].sum()
        R_chart3 = dcc.Graph(
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        average_sales = df.groupby(by=['Vehicle_Type','Automobile_Sales'])['unemployment_rate'].mean().reset_index()                             
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        exp_data=yearly_data.groupby(by='Vehicle_Type')['Advertising_Expenditure'].sum()
